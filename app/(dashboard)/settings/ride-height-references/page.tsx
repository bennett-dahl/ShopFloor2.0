      ...
      {loading ? (
        ...
        <div className="rounded-xl bg-white py-12 text-center dark:bg-zinc-800">
          ...
          <h3 className="mt-2 text-lg font-semibold text-zinc-900 dark:text-zinc-50">
            No ride height references yet
          </h3>
          <p className="mt-1 text-zinc-600 dark:text-zinc-400">
            Add references like &quot;Wheel center to fender&quot; or &quot;Ground to fender&quot;.
          </p>
          <button
            type="button"
            onClick={openAdd}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 dark:bg-zinc-800">
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">
              {editing ? "Edit ride height reference" : "Add ride height reference"}
            </h2>
            <form onSubmit={save} className="mt-4 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Wheel center to fender"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">
